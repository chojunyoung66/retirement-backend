...
import { IDLE_TIMEOUT_MS } from "../../shared/session-policy.js";
 ...
 */
export function authCookieOptions(maxAgeMs: number = IDLE_TIMEOUT_MS): CookieOptions {
...
export function setAuthCookie(
  res: Response,
  token: string,
  maxAgeMs: number = IDLE_TIMEOUT_MS,
): void {
