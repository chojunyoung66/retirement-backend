...
export const healthInsuranceSimulationSchema = z.object({
  ...
  interestDividendIncome: z
    .number()
    .nonnegative("이자·배당소득은 0 이상이어야 합니다"),
...
export type HealthInsuranceSimulationData = z.infer<
  typeof healthInsuranceSimulationSchema
>;
...
export type NationalPensionSimulationData = z.infer<
  typeof nationalPensionSimulationSchema
>;
...
export const irpSimulationSchema = z.object({
  annualContribution: z
    .number()
    .positive("연간 납입액은 양수여야 합니다")
    .max(18000000, "연간 납입액은 1800만원 이하여야 합니다"),
  expectedReturnRate: z
    .number()
  ...
  annualIncome: z
    .number()
    .positive("연 소득은 양수여야 합니다")
    .max(5000000000, "연 소득은 50억 이하여야 합니다"),
});
...
export type SeverancePaySimulationData = z.infer<
  typeof severancePaySimulationSchema
>;
